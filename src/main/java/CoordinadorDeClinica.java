...
public class CoordinadorDeClinica {
    ...
    public static void editarClinica() {
        Scanner input = new Scanner(System.in);
    ...
    public static void registrarPsiquiatra() {
        Scanner input = new Scanner(System.in);
        ...
        int idPsiquiatra;
        idPsiquiatra = clinica.psiquiatra.size();
    ...
    public static void borrarPsiquiatra() {
        Scanner input = new Scanner(System.in);
        ...
        for (int i = 0; i < clinica.psiquiatra.size(); i++) {
            Psiquiatra psiquiatra = clinica.psiquiatra.get(i);
            if (psiquiatra.idPsiquiatra == id) {
                psExiste = true;
                clinica.psiquiatra.remove(i);
    ...
    public static void suministrarMedicamentos() {
        ...
        Collections.sort(clinica.medicamento,
